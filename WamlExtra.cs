...
namespace WamlDesign
{
    public static class WamlExtra
    {
        ...
        public static readonly DependencyProperty LabelProperty =
            DependencyProperty.RegisterAttached("Label", typeof(string), typeof(WamlExtra), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty IsRequiredProperty =
            DependencyProperty.RegisterAttached("IsRequired", typeof(bool), typeof(WamlExtra), new PropertyMetadata(false));
        ...
        public static readonly DependencyProperty ErrorMessageProperty =
            DependencyProperty.RegisterAttached("ErrorMessage", typeof(string), typeof(WamlExtra), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty PlaceholderProperty =
            DependencyProperty.RegisterAttached("Placeholder", typeof(string), typeof(WamlExtra), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty CompactModeProperty =
            DependencyProperty.RegisterAttached("CompactMode", typeof(bool), typeof(WamlExtra), new PropertyMetadata(false));
