...
using WamlDesign.Internal;

namespace WamlDesign
{
    public class WamlDialog : Control
    {
        ...
        public static void Show(string title, string message, WamlDialogOptions dialogOptions = null)
        {
            GetHostWindow();
        ...
        public static async Task<DialogResult> ShowAsync(string title, string message, WamlDialogOptions dialogOptions = null)
        {
