...
namespace WamlDesign
{
    ...
    public class WamlWindow : Window
    {
        ...
        public static readonly DependencyProperty TitleAreaProperty =
          DependencyProperty.Register("TitleArea", typeof(Control), typeof(WamlWindow));

        public static readonly DependencyProperty ChromeWindowIconProperty =
          DependencyProperty.Register("ChromeWindowIcon", typeof(Control), typeof(WamlWindow));
        ...
        static WamlWindow()
        {
            DefaultStyleKeyProperty
                .OverrideMetadata(typeof(WamlWindow), new FrameworkPropertyMetadata(typeof(WamlWindow)));
        }
